    ...
    <div className="file-selector" style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            backgroundColor: showRecentFiles ? COLORS.accentMuted : COLORS.bgInput,
            border: `1px solid ${showRecentFiles ? COLORS.accent : COLORS.borderDefault}`,
            borderRadius: '8px',
            padding: '12px 14px',
            cursor: 'pointer',
            transition: 'all 0.15s ease',
            ...
            alignItems: 'center',
            gap: '6px',
            color: showRecentFiles ? COLORS.accent : COLORS.textSecondary,
            fontSize: '12px',
            fontWeight: '500'
          }}
          onMouseEnter={(e) => {
        ...
        <div style={{
          ...
          <RecentFiles
            onSelectFile={async (path) => {
              ...
              // The parent's handleSelectFile now accepts a presetPath parameter
