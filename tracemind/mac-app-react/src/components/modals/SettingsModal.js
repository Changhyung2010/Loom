            ...
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <input
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.boxShadow = `0 0 0 3px ${themeMode === 'light' ? 'rgba(0, 122, 255, 0.1)' : 'rgba(255, 255, 255, 0.1)'}`;
                  }}
                  onBlur={(e) => {
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  padding: '10px 16px',
                  color: themeMode === 'light' ? '#ffffff' : COLORS.bgBase,
                  fontSize: '13px',
                  fontWeight: '600',
                  cursor: 'pointer',
                  transition: 'all 0.15s ease',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '8px',
              padding: '10px 20px',
              color: apiKey.trim() ? (themeMode === 'light' ? '#ffffff' : COLORS.bgBase) : COLORS.textMuted,
              fontSize: '13px',
              fontWeight: '600',
